...
```{r key, warning =FALSE, message = FALSE}
...
```{r PopEstCount, message=FALSE, warning=FALSE}
...
```{r PopEstRange, message=FALSE, warning=FALSE}
...
```{r plot popchg, message = FALSE, warning =FALSE}
